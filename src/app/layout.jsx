    ...
    <html lang="en">
      <head>
        ...
        <meta
          ...
          content="San Miguel Corporation - Sustainability Website"
        />
        {/* <meta */}
        {/*   http-equiv="Content-Security-Policy" */}
        {/*   content="default-src 'self' https://ik.imagekit.io/ fonts.googleapis.com fonts.gstatic.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://localhost:3000/_next/static/chunks/;" */}
        {/* />{" "} */}
        {/* <meta */}
        {/*   httpEquiv="Content-Security-Policy" */}
        {/*   content="default-src 'self' https://ik.imagekit.io/; font-src 'self https://fonts.googleapis.com/ https://fonts.gstatic.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://localhost:3000/_next/static/chunks/; style-src 'self' https://localhost:3000/_next/static/css/**;" */}
        {/* /> */}
        <meta
          httpEquiv="Content-Security-Policy"
          content={`
