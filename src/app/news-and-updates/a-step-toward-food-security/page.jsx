...
export default function Page() {
  return (
    <section class="news-update-container"><div class="block-content"><div class="description-text"><div><div class="news-title"><h1> A step toward food security</h1></div><div><p>By: Melandrew Velasco<br />
      ...
      <br /><br />
      (The author is president and executive director of the Million Trees Foundation Inc., a non-profit group advocating tree planting and watershed protection. He is also a book writer and publisher of biographical and coffee-table books.)</p></div></div></div></div></section>
  )
}
