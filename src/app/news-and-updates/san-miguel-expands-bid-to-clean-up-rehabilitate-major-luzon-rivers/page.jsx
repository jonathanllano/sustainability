...
export default function Page() {
  return (
    <section className="news-update-container"><div className="block-content"><div className="description-text"><div><div className="news-title"><h1> San Miguel expands bid to clean up, rehabilitate major Luzon rivers</h1></div><div><p>By: Manila Standard<br />
      ...
      <br /><br />
      “This partnership enables DENR to achieve three main mandates by investing and allowing water to flow and impound it correctly where it is needed. Most of all, we are able to fulfill a new role assigned to us by our President when he created the Water Resources Management Office… We are very grateful to San Miguel Corporation for its kind and generous support to our government activities,” Loyzaga said.</p></div></div></div></div></section>
  )
}
