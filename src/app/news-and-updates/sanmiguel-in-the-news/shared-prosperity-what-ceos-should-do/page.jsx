    ...
    <section className="news-update-container">
      ...
      <div className="block-content">
        <div className="news-title">
          <h1>Shared prosperity: What CEOs should do</h1>
        </div>
        ...
        <div className='description-text'>
          ...
          <p>“As corporations, we have the responsibility to build communities that are empowered, resilient and self-actuating— not communities that are dependent on handouts because we don’t build prosperity that way,” she said.
          </p>
