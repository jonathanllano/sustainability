...
export default function Page() {
    return (
        <section class="news-update-container"><div class="block-content">
            <div class="description-text"><div><div class="news-title">
                <h1> SMGP secures P40 billion financing for BESS projects</h1>
            </div>
                <div>
                    <p>Richmond Mercurio - The Philippine Star<br />
